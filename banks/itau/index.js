...
exports.options = {
  logoURL: 'https://ssl6269.websiteseguro.com/recantodasaudade/rc-interno/adservonline/img/logo-itau.gif',
  codigo: '341'
}
...
exports.barcodeData = function (boleto) {
  ...
  var digito = boleto['digito'] 

  var nossoNumero = boleto['nosso_numero'] 
  var dac = formatters.mod10(agencia + codigoCedente + carteira + nossoNumero);
  
  var barra = codigoBanco + numMoeda + fatorVencimento + valor + carteira + nossoNumero + dac + agencia + codigoCedente + digito + '000'

  var dvBarra = this.dvBarra(barra)

  boleto['codigo_cedente'] = codigoCedente + '-' + digito
  boleto['nosso_numero'] = nossoNumero + '-' + dac
